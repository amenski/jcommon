...
public class SerialDateUtilitiesTest extends TestCase {
    ...
    public void testDayCountActual() {
        final SerialDate d1 = SerialDate.createInstance(1, MonthConstants.APRIL.get(), 2002);
        final SerialDate d2 = SerialDate.createInstance(2, MonthConstants.APRIL.get(), 2002);
